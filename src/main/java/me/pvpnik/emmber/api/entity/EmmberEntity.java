...
/**
 * Only an example, should not be used
 * *Change EntityMonster to your needed entity
 */
class EmmberEntity extends EntityMonster implements EmmberMob {
    ...
    public EmmberEntity(World world) {
        super(world);
    }

    public EmmberEntity(Location loc) {
    ...
    public void die(DamageSource damagesource) {
        ...
        OUT.toConsole("killer: " + killer);
        if (killer != null) {
            Bukkit.broadcastMessage("killer name: " + killer.getName());
     ...
     * @param itemstack
     */
    public EmmberEntity setSlot(EnumItemSlot enumitemslot, org.bukkit.inventory.ItemStack itemstack) {
    ...
    public EmmberEntity setLevel(int level) {
        this.level = level;
        return this;
    }
    ...
    public EmmberEntity setHp(double hp) {
        this.hp = hp;
        return this;
    }
    ...
    public EmmberEntity setArmor(int armor) {
        this.armor = armor;
        return this;
    }
    ...
    public EmmberEntity setMinDamage(int minDamage) {
    ...
    public EmmberEntity setMaxDamage(int maxDamage) {
    ...
    public EmmberEntity setExp(int exp) {
        this.exp = exp;
        return this;
    }
    ...
    public EmmberEntity setMinMoney(int minMoney) {
    ...
    public EmmberEntity setMaxMoney(int maxMoney) {
