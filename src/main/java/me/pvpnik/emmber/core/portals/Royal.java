...
public class Royal extends EmmberPortal {

    public Royal() {
        super("Royal", new Location(Emmber.getInstance().getWorld(), 10, 88, 41),
        ...
        setDeny(new Location(Emmber.getInstance().getWorld(), 18, 82, 39));

        // Player Must Have:
        setPermission("portal.royal");
        setFeeInPoints(0);
        setPrizeInPoints(0);
        setMinlevel(0);
